...
# ABANDONNED: Can't figure out how the FUCK yt-dlp downloads YT files so fast, using this, YouTube throttles us to 0.3mb/s! Yikes!
...
async def Proxy() -> None:
	...
	async def Stream_Proxy():
		...
		async with httpx.AsyncClient.stream(method="GET", url=Proxied_URL, headers=Proxied_Headers, follow_redirects=False) as Stream:
